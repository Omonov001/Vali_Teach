...
function Navbar({ user, setUser }) {
  ...
  return (
    <div className="Navbar w-[82%] absolute my-1 mx-[265px] h-[90px] rounded-md bg-base-300 shadow-sm flex items-center justify-between px-6">
      ...
      <div className="black mr-[550px] bg-base-300">
        <button
          className="btn"
        ...
        <dialog id="my_modal_1" className="modal">
          <div className="modal-box">
            ...
            <div className="modal-action">
              <form method="dialog">
                <button className="btn w-28"><h2>Yopish</h2></button>
              </form>
            </div>
          </div>
        </dialog>
      ...
      <br />
      <div className="flex rounded-full ml-10 text-center justify-center items-center gap-4">
        <h1>{user?.displayName ? user.displayName : "Anonim"}</h1>
        <div className="dropdown dropdown-end">
          ...
          >
            <div className="w-10 rounded-full">
              <img
                className="IMG  pt-12 absolute z-50 rounded-full right-0 bottom-[-0px]"
                alt="Tailwind CSS Navbar component"
                src={user?.photoURL || "/public/image copy 23.png"}
              />
            </div>
          </div>
          <ul
          ...
          >
            <Link to="/profile">
              <li>
                <h1 className="text-xl justify-between">Profile</h1>
              </li>
            </Link>
            <li>
